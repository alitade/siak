 ...
 * @var app\modules\transkrip\models\PeopleSearch $searchModel
 */
...
<div class="people-index">
    ...
    <p>
        <?php /* echo Html::a('Create People', ['create'], ['class' => 'btn btn-success'])*/  ?>
    </p>
...
//            'ibu_kandung', 
            ...
            [
                ...
                'update' => function ($url, $model) {
                                    return Html::a('<span class="glyphicon glyphicon-pencil"></span>', Yii::$app->urlManager->createUrl(['transkrip/people/view','id' => $model->No_Registrasi,'edit'=>'t']), [
