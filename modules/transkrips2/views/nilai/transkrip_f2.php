...
//	if($LenStr>1){$no +=($LenStr-1);}
	...
	if($no<=$pembagi){
		...
		<tr align='left'> 
			...
			<td valign='top' class='bdr'>$data[kode_mk]".($data['kat']==1?'*':"")."</td>
...
<table width="100% !important" border="0" style="margin-top:2px;font-size:12px;height:650mm" autosize="0">
    ...
    <td align="right"  valign="top">
    	<table>
			...
			?>
        	<tr><td align="left"><br />Bandung, <?= app\models\Funct::TANGGAL($tglCetak,2)?><div>Rektor Universitas Sangga Buana YPKP</div></td></tr>
        	<tr><td height="100"></td></tr>
