 ...
 */
class MasterSearch extends Jadwal //Rekap
{
    ...
    public function rules(){
        return [
            [['id','sesi','jdwl_id', 'jdwl_hari',], 'integer'],
            [[
				'mtk_kode', 'mtk_nama', 'jdwl_masuk', 'jdwl_keluar', 
				'tgl', 
				
				'hadir','kr_kode',
				'pMasuk','pKeluar','jAwal','sesi','pr_kode'
				]
			, 'safe'],
        ];
    }
    ...
    public function search($params,$kr,$kon='',$order=''){
        ...
        ->innerJoin("dbo.m_kahadiran_semester('$kr') tf","tf.jdwl_id=jd.jdwl_id")
