 ...
 * @property string $kode_pos_sekolah
 ...
 */
class KPeople extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['No_Registrasi', 'Nama', 'tempat_lahir', 'jenis_kelamin', 'agama', 'kewarganegaraan', 'status', 'alamat', 'kota', 'kode_pos', 'propinsi', 'negara', 'asal_sekolah', 'status_sekolah', 'alamat_sekolah', 'kode_pos_sekolah', 'telepon_sekolah', 'nomor_sttb', 'fakultas', 'program_studi', 'nama_ortu_wali', 'alamat_ortu_wali', 'kode_pos_ortu_wali', 'telepon_ortu_wali', 'status_terima', 'ket_beasiswa', 'ket_program', 'ket_pendapat', 'Foto'], 'string'],
            [['tanggal_lahir', 'tahun_lulus', 'tgl_daftar'], 'safe'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'kode_pos_sekolah' => 'Kode Pos Sekolah',
