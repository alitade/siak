    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse">
            ...
            <ul class="nav navbar-nav">
                ...
                <li>
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="glyphicon glyphicon-tower"></i> Direktorat IT<b class="caret"></b></a>
                    <ul class="dropdown-menu multi-level">
                        <li><a href="<?= Url::to(['/berita/pudi', 'id'=>Yii::$app->user->id])?>"><i class="glyphicon glyphicon-exclamation-sign"></i> Berita</a></li>
                    </ul>
                </li>
        </div><!--/.nav-collapse -->
    </div>
