        ...
        <div class="collapse navbar-collapse">
            ...
            <ul class="nav navbar-nav">
                ...
                <li>
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="<?= Url::to(['/mode1/mtk'])?>"><i class="glyphicon glyphicon-book"></i> Matakuliah</a></li>
                        <li class="dropdown-submenu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="glyphicon glyphicon-tasks"></i> Penjadwalan</a>
                            <ul class="dropdown-menu">
                                <li><a href="<?= Url::to(['/mode1/ajr'])?>">Daftar Pengajar</a></li>
                                <li><a href="<?= Url::to(['/mode1/jdw'])?>">Jadwal Kuliah</a></li>
                                <!-- <li><a href="<?= Url::to(['/rekap-absen/perkuliahan'])?>">Absensi Perkuliahan</a></li>-->
                            </ul>
                        </li>
                        <li><a href="<?= Url::to(['/mode1/mhs'])?>"><i class="glyphicon glyphicon-user"></i> Mahasiswa</a></li>
                    </ul>
                </li>
                <li>
