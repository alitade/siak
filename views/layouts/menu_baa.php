        ...
        <div class="collapse navbar-collapse">
            ...
            <ul class="nav navbar-nav">
                ...
                <li>
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="<?= Url::to(['/akademik/mtk'])?>"><i class="glyphicon glyphicon-book"></i> Matakuliah</a></li>
                        ...
                        <li><a href="<?= Url::to(['/berita/baa', 'id'=>Yii::$app->user->id])?>"><i class="glyphicon glyphicon-info"></i> Berita</a></li>
