            ...
            <ul class="nav navbar-nav">
                ...
                <li>
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="<?= Url::to(['/pasca/mtk'])?>"> <i class="glyphicon glyphicon-book"></i> Matakuliah</a></li>
                        <li><a href="<?= Url::to(['/akademik/kr'])?>"> <i class="glyphicon glyphicon-calendar"></i> Kurikulum</a></li>
                        <li><a href="<?= Url::to(['/pasca/kln'])?>"> <i class="glyphicon glyphicon-calendar"></i>Kalender Akademik</a></li>
                        <li class="dropdown-submenu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class="glyphicon glyphicon-tasks"></i> Penjadwalan</a>
                            <ul class="dropdown-menu">
                                <li><a href="<?= Url::to(['/pasca/ajr'])?>">Daftar Pengajar</a></li>
                                <li><a href="<?= Url::to(['/pasca/jdw'])?>">Jadwal Kuliah</a></li>
                                <li><a href="<?= Url::to(['/pasca/uts'])?>">Jadwal UTS</a></li>
                                <li><a href="<?= Url::to(['/pasca/uas'])?>">Jadwal UAS</a></li>
                            </ul>
                        </li>
                        <li><a href="<?= Url::to(['/pasca/mhs'])?>"> <i class="glyphicon glyphicon-user"></i> Mahasiswa</a></li>
                        <li><a href="<?= Url::to(['/pasca/krs-t'])?>"> <i class="glyphicon glyphicon-user"></i> Input KRS</a></li>
                        <li><a href="<?= Url::to(['/pasca/dsn'])?>"> <i class="glyphicon glyphicon-user"></i> Dosen Wali</a></li>
