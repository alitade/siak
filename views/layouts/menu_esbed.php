        ...
        <div class="collapse navbar-collapse">
            ...
            <ul class="nav navbar-nav">
                ...
                <li>
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="<?= Url::to(['/esbed/mhs'])?>"><i class="glyphicon glyphicon-user"></i> Mahasiswa</a></li>
                        <li><a href="<?= Url::to(['/esbed/mtk'])?>"><i class="glyphicon glyphicon-book"></i> Matakuliah</a></li>
                        <li><a href="<?= Url::to(['/esbed/jdw'])?>"><i class="glyphicon glyphicon-tasks"></i> Penjadwalan</a></li>
                        <li><a href="<?= Url::to(['/esbed/prw'])?>"><i class="glyphicon glyphicon-user"></i> Perwalian</a></li>
                        <li><a href="<?= Url::to(['/esbed/nil'])?>"><i class="glyphicon glyphicon-user"></i> Nilai</a></li>
                    </ul>
                </li>
            </ul>
        </div><!--/.nav-collapse -->
