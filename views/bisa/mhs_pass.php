            ...
            [
                ...
                'buttons' => [
                    'update' => function ($url, $model) {
                        ...
                        Yii::$app->urlManager->createUrl(['bisa/mhs-pass','id' => $model->mhs_nim,'edit'=>'t']), 
                        ['title' => Yii::t('yii', 'resset Pass'),'onClick'=>"return confirm('Yakin NPM ".$model->mhs_nim." Di reset Boss??')" ]);},
