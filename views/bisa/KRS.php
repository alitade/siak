...
<div class="panel panel-primary">
    ...
    <table class='table table-hover table-condensed'>
        ...
        <tr>
            <td>Nama</td>
            <td><?= Funct::profMhs(@$_GET['nim'],"Nama");?></td>
        </tr>
        <tr>
            <td>Jurusan</td>
        ...
        <tr>
            <td>Pembimbing</td>
            <td><?= Funct::nameWaliK(@$mhs->ds_wali,"ds_nm");?></td>
        </tr>        
        <?php endif;?>
    </table>
</div>
...
if(isset($_GET['Krs']['kurikulum']) ){
	...
	//( Funct::CekTgl($ThnId)?
		Html::a(
			...
			['bisa/tambah-krs','Krs[kurikulum]' => $tahun,'nim'=>$_GET['nim']],
			['class'=>' btn btn-success']
		)." ".//:" "
	//).
	Html::a(
		"<i class='glyphicon glyphicon-print'></i> Cetak KRS",
		['bisa/cetak-krs','nim'=>$_GET['nim'],'kurikulum'=>isset($_GET['Krs']['kurikulum']) 
		? $_GET['Krs']['kurikulum'] 
		: ""],
  ...
  echo GridView::widget([
        ...
        [
         ...
         [
             'header'  => 'Aksi',
             'value' => function($data) {
                    return false ? "" : Html::a('<center><i class="glyphicon glyphicon-trash"></i></center>',["bisa/delete-krs","id"=>$data["krs_id"],"kurikulum" => $_GET["Krs"]["kurikulum"],"nim" => @$_GET["nim"],'onclick'=>"return confirm('Apakah anda yakin akan menghapus data ini?')" ]);
                },
             'format'  => 'raw',
         ],                                                                       
