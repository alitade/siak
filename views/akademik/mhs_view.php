...
<div class="mahasiswa-view">
    <p>
        <?=
            Html::a('<i class="glyphicon glyphicon-list-alt"></i> KHS ( Kartu Hasil Study )', ['akademik/mhs-khs', 'id' => $model->mhs_nim],['class'=>'btn btn-warning','visible'=>false]) ?>
        <?=
        (
            \app\models\Funct::acc('/akademik/mhs-people')?
            Html::a('<i class="glyphicon glyphicon-pencil"></i> Update Biodata', ['akademik/mhs-people', 'id' => $model->mhs_nim],['class'=>'btn btn-success']):""
        )
        ?>
    </p>
