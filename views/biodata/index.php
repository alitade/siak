...
<div class="biodata-index">
    ...
    <p>
        <?php /* echo Html::a('Create Biodata', ['create'], ['class' => 'btn btn-success'])*/  ?>
    </p>
...
//            'Rstat', 
            ...
            [
                ...
                'update' => function ($url, $model) {
                                    return Html::a('<span class="glyphicon glyphicon-pencil"></span>', Yii::$app->urlManager->createUrl(['biodata/view','id' => $model->id,'edit'=>'t']), [
