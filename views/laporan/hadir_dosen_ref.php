...
$this->title="Pratinjau Revisi Kehadiran Dosen";
...
<div class="panel panel-default">
    <div class="panel-heading">
        <span class="panel-title" style="text-transform: uppercase;font-size: 14px;font-weight: bold">REVISI[ Pratinjau <?= $fileName  ?> ]</span>
    </div>
    <div class="panel-body">
        ...
        if($def['GKode']) {
            ?>
                ...
                <?= Html::a('<i class="fa fa-download"></i> Download Data', ['/laporan/kehadiran-dosen-rf', 'id' => $model->id, 'd' => 1], ['class' => 'btn btn-primary', 'target' => '_blank']) ?>
                <p></p>
                <div class="raw">
                    <style>
                        #c {
                    ...
                    <div style="overflow:auto;height:1000px">
                        <table style=" white-space: nowrap;" id="c">
                            ...
                            foreach ($q as $d) {
                                ...
                                <td>  " . implode("<br>", $MK) . " </td>
                                <td> $d[7] </td><td> $d[8] </td><td> " . substr($KLS, 1) . "  </td><td> $totMhs </td>";
                                $hadir = 0;
                ...
                <?php
            }else{ echo "<div class='text-center' style='font-size: 16px;font-weight: bold'>Data Revisi Tidak Ada</div>"; }
        ?>
    </div>
