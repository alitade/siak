 ...
 <tr>
   <th height="35" style="align-content: center; text-align: center; font-size: 20pt;"
    colspan="12" align="center" valign="middle" scope="row">DAFTAR HADIR <?=$jenis?></th>  
 	...
 	<tr><td width="187" colspan="2" style=" padding-left: 9px;font-size:14pt; "><b>Hari, Tanggal / Jam</b></td><td  colspan="5" style="font-size:15pt; padding-left: 9px;"><?= Funct::HARI()[date('w',strtotime($header['tanggal']))]  ?>, <?=Funct::TANGGAL($header['tanggal'])?> /
    <?= substr($header['jam'],0,5)?>
    </td>
