...
<div class="panel panel-primary">
    ...
    <div class="form-group" style="text-align: right;">
        ...
        <?= Html::a('<i class="glyphicon glyphicon-refresh"></i> Reset', ['piket/jdw'],['class' => 'btn btn-danger']) ?>
    </div>
    <?php ActiveForm::end(); ?>
    </div>
</div>
...
,*/		
        'toolbar'=> [
            ['content'=>
                //Html::a('<i class="glyphicon glyphicon-plus"></i> Tambah', ['piket/jdw-create'],['class'=>'btn btn-success']).''.
                //Html::a('<i class="glyphicon glyphicon-download-alt"></i> Export', ['piket/report-jadwal-kuliah'],['class'=>'btn btn-info'])
			...
			[
				...
				'value'=>function($model){
					...
					Yii::$app->urlManager->createUrl(
						['piket/jdw-detail','id' => $model->jdwl_id]),['title' => Yii::t('yii', 'Detail'),]
					);
				},
			...
			[
				...
				'buttons' => [
					'dtl'=> function ($url, $model, $key) {
							...
							,['piket/jdw-view','id' => $model->jdwl_id,'view'=>'t']);
						},
					'gnt'=> function ($url, $model, $key) {
							return Html::a('<i class="glyphicon glyphicon-list"></i> Jadwal Sementara'
							,['piket/jdw-temp','id' => $model->jdwl_id,'view'=>'t']);
						},
					'edt'=> function ($url, $model, $key) {
							return Html::a(
								'<span class="glyphicon glyphicon-list"></span> Edit Absen',
								['piket/jdw-update','id' => $model->jdwl_id,'view'=>'t']
							);
						},
					...
					'c_uts1'=> function ($url, $model, $key) {
							return Html::a(
								...
								['piket/cetak-absensi-ujian','id' => $model->jdwl_id, 'jenis'=>1]
							);
						},
					'c_uas1'=> function ($url, $model, $key) {
							return Html::a(
								'<span class="glyphicon glyphicon-list"></span> Cetak Absen UAS Printer LX310',
								['piket/cetak-absensi-ujian','id' => $model->jdwl_id, 'jenis'=>2]
							);
						},
