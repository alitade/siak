...
<table class="" style="margin-bottom: 0px;margin-top: -38px;" width="100%" border="0">  
  <tbody><tr>
    <td width="10%"><img style="margin-bottom: -17px; margin-top: 12px;" src="<?php echo Url::to('@web/images/logo.jpg'); ?>" width="60px"></td>
    <td width="100%">
      <div>
...
<?php
//    echo " tanggal ".$header['tanggal'];
    $waktu='________ , __ ___ __ / __:__ ';
    if($header['tanggal']){$waktu = trim(Funct::HARI()[date('w',strtotime($header['tanggal']))]) .', '.trim(Funct::TANGGAL($header['tanggal'])) . ' / '.trim(substr($header['jam'],0,5));}
  ...
  <!-- KODING -->
   ...
   <?php 
    ...
    <?php 
        ...
        $persen = $m['persen'] <=100?$m['persen']:100;
