...
$this->title = 'Registrasi NPM Mahasiswa';
            ...
            echo Form::widget([
                ...
                'attributes' => [
                    [
                        ...
                        'columns'=>3,
                        'attributes'=>[
                            ['type'=>Form::INPUT_RAW,'value'=>Html::textInput('id',$model->No_Registrasi,['class'=>'form-control'])],
                            ['label'=>false,'type'=>Form::INPUT_RAW,'value'=>Html::submitButton('<i class="fa fa-save"></i> Cari Data',['class'=>'btn btn-success'])],
                        ],
...
<?php if($model):
    ...
    <div class="panel">
        <div class="panel-heading">
            <div style="border-bottom:solid 1px rgba(0,0,0,0.3);"><span style="font-size:14px;font-weight:bold">BIODATA</span></div>
        ...
        if($model->npm) {
            ...
            <div class="panel-body">
                <table class="table table-bordered">
                    <tr><th width="30%"> Fakultas / Program Studi</th><td><?= $model->jr->fk->fk_nama ?> / <?= $model->jr->jr_jenjang . ' ' . $model->jr->jr_nama?></td></tr>
                    <!--tr><th> Program Studi</th><td><?= $model->jr->jr_jenjang . ' ' . $model->jr->jr_nama?></td></tr -->
                    <tr><th> Program Perkuliahan</th><td><?= $model->pr->pr_nama?></td></tr>
                    <tr><th> Semester Awal</th><td>Semester <?= $model->semester_lanjutan ?></td></tr>
                    <tr><th> NPM / Status </th><td><?= $model->npm ?> / <?= $Status[$model->status_pendaftaran] ?></td></tr>
                    <tr><th> Angkatan / Kurikulum Masuk</th><td>  <?= $model->angkatan." / ".$model->kurikulum ?></td></tr>
                    <tr>
                        <th> Kode Tarif</th>
                        <td><?= $model->tarif->kode_tarif ?></td>
                    </tr>
        ...
        <?php } else{ ?>
            <div class="raw">
                <div class="col-md-6">
                    ...
                    <table class="table table-bordered table-condensed">
                        <thead>
                        <tr><th width="160px">Konsultan Pendaftaran</th><td> <?= $model->konsultan->vendor ?> </td></tr>
                        <tr><th>Fakultas</th><td> <?= $model->jr->fk->fk_nama ?> </td></tr>
                        <tr><th>Jurusan</th><td> <?= $model->jr->jr_jenjang.' '.$model->jr->jr_nama ?> </td></tr>
                        <tr><th>Program</th><td> <?= $model->pr->pr_nama ?> </td></tr>
                        </thead>
                ...
                <div class="col-md-6">
                    ...
                    Form::widget([
                        ...
                        'attributes' => [
                            ...
                            ['type'=>Form::INPUT_RAW,'value'=> Html::submitButton('Save',['class'=>'btn btn-primary btn-sm pull-right']),],
...
$('#daftarnpm-semester_lanjutan').change(function(){ $('#daftarnpm-npm').val('');});
$('#daftarnpm-kurikulum').change(function(){ $('#daftarnpm-npm').val(''); });
