    ...
    'columns' => [
        ...
        [
            ...
            'value'=>function($model){
				...
				.Html::a(' <i class="fa fa-pencil-square-o"></i>  Bobot & Grade',['/dosen/bobot-nilai','k'=>$model['GKode']],['class'=>'btn btn-primary btn-sm'])." "
				.($info?"":Html::a('<i class="fa fa-pencil-square-o"></i> Nilai','#',['class'=>'btn btn-primary btn-sm'])." ")
				.Html::a('<i class="fa fa-pencil-square-o"></i> Kehadiran Mahasiswa','#',['class'=>'btn btn-primary btn-sm'])
				//.($info?" <br /><span class='label label-danger'>".substr($info,0,-1)."Nilai Belum Ada</span>":"")
				;
            },
		...
		[
			...
			'format'=>'raw',
			'value'=>function($model){
				return ($model['Lock']>0 ?' <i class="glyphicon glyphicon-lock" title="Nilai Sudah Terkunci"></i> ':" ")." $model[Kode]: $model[Matakuliah] ($model[Kelas])";
			}
		],
        'SKS',
        [
