 ...
 * @var app\models\TKrsDetSearch $searchModel
 */

$this->title = 'Tkrs Dets';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="tkrs-det-index">
    ...
    <p>
        <?php /* echo Html::a('Create Tkrs Det', ['create'], ['class' => 'btn btn-success'])*/  ?>
    </p>
...
//            ['attribute'=>'tgl_jdwl','format'=>['datetime',(isset(Yii::$app->modules['datecontrol']['displaySettings']['datetime'])) ? Yii::$app->modules['datecontrol']['displaySettings']['datetime'] : 'd-m-Y H:i:s A']], 
//            'krs_stat', 
//            'ket', 
//            'krs_ulang', 
//            'RStat', 
...
//            ['attribute'=>'dtgl','format'=>['datetime',(isset(Yii::$app->modules['datecontrol']['displaySettings']['datetime'])) ? Yii::$app->modules['datecontrol']['displaySettings']['datetime'] : 'd-m-Y H:i:s A']], 
            ...
            [
                ...
                'update' => function ($url, $model) {
                                    return Html::a('<span class="glyphicon glyphicon-pencil"></span>', Yii::$app->urlManager->createUrl(['tkrs-det/view','id' => $model->id,'edit'=>'t']), [
