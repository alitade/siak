...
$form1 = ActiveForm::begin([
    ...
    'action'=>['mhs-delete']
    #'formConfig'=>['options'=>['onSubmit'=>'return confirm("Hapus Data?")']]
]);
...
echo GridView::widget([
    ...
    'header'=>true,
    'before'=>
        Html::a('<i class="fa fa-search"></i> Pencarian Data', ['#'], ['class' => 'btn btn-info','id'=>'popupModal' ])." "
        .Html::a('<i class="fa fa-list"></i> Daftar Matakuliah', ['#'], ['class' => 'btn btn-info','id'=>'popupModal1' ])." "
        .(!Funct::acc('/matkul-kr/delete')?" ":Html::a("<i class='fa fa-plus'></i> Daftarkan Mahasiswa",['mhs-create','id'=>$model->id],["class"=>'btn btn-primary','name'=>'u']))." "
        .(!Funct::acc('/matkul-kr/delete')?" ":Html::submitButton("<i class='fa fa-trash'></i> Hapus Data Terpilih",["class"=>'btn btn-danger','name'=>'u','data-confirm'=>'Lakukan Penghaousan Data???']))." "
    ,
]
        ]);
    ActiveForm::end();
