			...
			[
				...
				'value'=>function($model){
					...
					return Html::a('<span class="glyphicon glyphicon-eye-open"></span>',
						Yii::$app->urlManager->createUrl(
							['akademik/jdw-view','id' => $model->jdwl_id,'view'=>'t']),['title' => Yii::t('yii', 'Detail'),]
						)." "
						.Html::a('<span class="glyphicon glyphicon-pencil"></spank>',
						 Yii::$app->urlManager->createUrl(['akademik/jdw-update','id' => $model->jdwl_id,'edit'=>'t']),
						 ...
						 .( 
							...
							Yii::$app->urlManager->createUrl(
								['akademik/jdw-view','id' => $model->jdwl_id,'delete'=>'t']),
						...
						Yii::$app->urlManager->createUrl(
							['bisa/attendance','id' => $model->jdwl_id, 'matakuliah'=>$model->mtk_kode, 'sort'=>'id']),['title' => Yii::t('yii', 'Absensi'),]
						)." " 
						.Html::a('<span class="glyphicon glyphicon-th-list"></span>',
						Yii::$app->urlManager->createUrl(
							['bisa/attendance','id' => $model->jdwl_id, 'matakuliah'=>$model->mtk_kode, 'sort'=>'id']),['title' => Yii::t('yii', 'Absensi'),]
