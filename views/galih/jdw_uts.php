...
$this->title = 'Jadwal UTS '.(isset($_SESSION['Ckln'])? app\models\Funct::AKADEMIK()[$_SESSION['Ckln']]:'');
...
<div class="jadwal-index">
    <?php Pjax::begin(); echo GridView::widget([
        ...
        'toolbar'=> [
            ['content'=>
                Html::a('<i class="glyphicon glyphicon-download-alt"></i>', ['akademik/report-jadwal-uts'],['class'=>'btn btn-info'])
            ],
            '{toggleData}',
        ],
        'columns' => [
			...
			[
				...
				'value'=>function($model){
					...
					return $model->jdwl_uts."<br />".$model->jdwl_uts_out;	
				}
			],
			[
				'attribute'=>'rg_uts',
				'width'=>'10%',
				'value'		=> function($model){
					return app\models\Funct::RUANG()[$model->rg_uts];
