...
<?php foreach ($header['header'] as $k => $h): ?>
 ...
 <tr>
   <th height="35" style="align-content: center; text-align: center; font-size: 20pt;"
    colspan="12" align="center" valign="middle" scope="row">DAFTAR HADIR <?=$jenis?></th>  
 	...
 	<tr>
 	<td width="300" colspan="2" style="font-size:14pt; padding-left: 9px;"><b>Mata Kuliah</b></td><td  colspan="5" style="font-size:14pt; padding-left: 9px;"><?=$header['header'][$k]['matakuliah']?></td>
 	<td colspan="2" style="font-size:14pt;  padding-left: 9px;"><b>Ruangan</b></td><td colspan="3" style="font-size:14pt; padding-left: 9px;"><?=$header['header'][$k]['RgKode'].' / '.$header['header'][$k]['ruang']?></td></tr>
 	<tr><td width="187" colspan="2" style="font-size:14pt;  padding-left: 9px;"><b>Nama Dosen</b></td><td  colspan="5" style="font-size:15pt; padding-left: 9px;"><?=$header['header'][$k]['dosen']?></td>
 	<td colspan="2" style=" padding-left: 9px;font-size:14pt; "><b>Program</b></td><td colspan="3" style="font-size:14pt; padding-left: 9px;"><?=$header['header'][$k]['kode'].":".$header['header'][$k]['program']." (".$header['header'][$k]['kelas'].") "?></td></tr>
 	<tr><td width="187" colspan="2" style=" padding-left: 9px;font-size:14pt; "><b>Hari, Tanggal / Jam</b></td><td  colspan="5" style="font-size:15pt; padding-left: 9px;"><?= Funct::HARI()[date('w',strtotime($header['header'][$k]['tanggal']))]  ?>, <?=Funct::TANGGAL($header['header'][$k]['tanggal'])?> /
    <?= $header['header'][$k]['jam']?>
    </td>
 	<td colspan="2" style=" padding-left: 9px;font-size:14pt; "><b>Semester</b></td><td colspan="3" style="font-size:14pt; padding-left: 9px;"><?=$header['header'][$k]['semester']?></td></tr>
  <tr>
	...
	<?php 
	$num = 1;
	foreach ($header['header'][$k]['student'] as $m): ?>
		<?php
		$absen=$m['absen'];
			 ...
			 <tr>
			   <th height="35" style="align-content: center; text-align: center; font-size: 20pt;"
			    colspan="12" align="center" valign="middle" scope="row">DAFTAR HADIR <?=$jenis?></th>  
			 	...
			 	<td colspan="2" style="font-size:14pt;  padding-left: 9px;"><b>Ruangan</b></td><td colspan="3" style="font-size:14pt; padding-left: 9px;"><?=$header['header'][$k]['RgKode'].' / '.$header['header'][$k]['ruang']?></td></tr>
			 	<tr><td width="187" colspan="2" style="font-size:14pt;  padding-left: 9px;"><b>Nama Dosen</b></td><td  colspan="5" style="font-size:15pt; padding-left: 9px;"><?=$header['header'][$k]['dosen']?></td>
			 	<td colspan="2" style=" padding-left: 9px;font-size:14pt; "><b>Program</b></td><td colspan="3" style="font-size:14pt; padding-left: 9px;"><?=$header['header'][$k]['program']?></td></tr>
			 	<tr><td width="187" colspan="2" style=" padding-left: 9px;font-size:14pt; "><b>Hari, Tanggal / Jam</b></td><td  colspan="5" style="font-size:15pt; padding-left: 9px;"><?= Funct::HARI()[date('w',strtotime($header['header'][$k]['tanggal']))]  ?>, <?=Funct::TANGGAL($header['header'][$k]['tanggal'])?> / <?=$header['header'][$k]['jam']?> </td>
			 	<td colspan="2" style=" padding-left: 9px;font-size:14pt; "><b>Semester</b></td><td colspan="3" style="font-size:14pt; padding-left: 9px;"><?=$header['header'][$k]['semester']?></td></tr>
			  <tr>
			    <th width="35" style="align-content: center; text-align: center;" align="center" valign="middle"  nowrap="nowrap"  scope="col">NO</th>
			    <th width="150" style="align-content: center; text-align: center;" align="center" valign="middle"  nowrap="nowrap" scope="col">NPM</th>
