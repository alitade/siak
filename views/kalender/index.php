...
<div class="kalender-index">
    ...
    <p>
        <?php /* echo Html::a('Create Kalender', ['create'], ['class' => 'btn btn-success'])*/  ?>
    </p>
    ...
    <?php Pjax::begin(); echo GridView::widget([
        ...
        'columns' => [
            ...
            'jr_id',
            'pr_kode',
            ['attribute'=>'kln_krs','format'=>['datetime',(isset(Yii::$app->modules['datecontrol']['displaySettings']['datetime'])) ? Yii::$app->modules['datecontrol']['displaySettings']['datetime'] : 'd-m-Y H:i:s A']],
...
//            'kln_sesi', 
            ...
            [
                ...
                'update' => function ($url, $model) {
                                    return Html::a('<span class="glyphicon glyphicon-pencil"></span>', Yii::$app->urlManager->createUrl(['kalender/view','id' => $model->kln_id,'edit'=>'t']), [
