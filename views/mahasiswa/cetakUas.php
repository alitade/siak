...
GridView::widget([
    ...
    'columns' => [
         ...
         [
             'header'  => 'Jadwal UTS',
             'value' => function($data) {
		            return $data["jdwl_uas"];//Funct::getHari()[$data["jdwl_hari"]].", ". $data["jdwl_masuk"]."-".$data["jdwl_keluar"];
	            },
             'format'  => 'raw',
         ],
         [
             'header'  => 'Jam',
             'value' => function($data) {
		            return $data["jdwl_uas"]." - ".$data["jdwl_uas_out"] ;//Funct::getHari()[$data["jdwl_hari"]].", ". $data["jdwl_masuk"]."-".$data["jdwl_keluar"];
	            },
             'format'  => 'raw',
         ],                                                                                                
         [
