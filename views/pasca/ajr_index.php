...
<div class="bobot-nilai-index">
    ...
    <?php Pjax::begin(); echo GridView::widget([
        ...
        'toolbar'=> [
            ['content'=>
                Html::a('<i class="glyphicon glyphicon-plus"></i> Tambah', ['pasca/ajr-create'],['class'=>'btn btn-success']).''.
                Html::a('<i class="glyphicon glyphicon-download-alt"></i> Export', ['pasca/report-pengajar'],['class'=>'btn btn-info'])
            ],
            '{toggleData}',
        ],
        'columns' => [
			...
			[
				...
				'value'=>function($model){
					...
					Yii::$app->urlManager->createUrl(['pasca/ajr-view',
					'id'=> $model->id,
					'edit'=>'t'])
            ...
            [
                ...
                'update' => function ($url, $model) {
					...
					Yii::$app->urlManager->createUrl(['pasca/ajr-update','id' => $model->id,'edit'=>'t'])
					,['title' => Yii::t('yii', 'Edit'),]);},
                'view' => function ($url, $model) {
						return Html::a('<span class="glyphicon glyphicon-plus"></span>',
						Yii::$app->urlManager->createUrl(
							['pasca/ajr-view','id' => $model->id,'view'=>'t']),
                ...
                'delete' => function ($url, $model) {
                            ...
                            Yii::$app->urlManager->createUrl(
                                ['pasca/ajr-delete','id' => $model->id,'delete'=>'t']),['title' => Yii::t('yii', 'Hapus'),]
                            );
                        },
