...
<div class="page">
 <table width="100%"  border="0" class="" style="margin-bottom: 0px;margin-top: -20px;" cellpadding="0" cellspacing="0" >  
  <tr>
    <td width="10%"><img style="margin-bottom: -15px; margin-top: 2px;" src="<?php echo Url::to('@web/ypkp.png'); ?>" width="40px"></td>
    <td width="100%">
      <div>
...
<thead> 
 <tr>
   <th height="35" style="align-content: center; text-align: center; font-size:10pt;text-transform:uppercase"
 ...
 <tr>
  ...
  <tr>
    <th width="20" style="align-content: center; text-align: center;" align="center" valign="middle">NO</th>
    <th width="150" style="align-content: center; text-align: center;" align="center" valign="middle"  nowrap="nowrap" scope="col">Nama dan NPM</th>
	<!-- sesi -->
    ...
    <th width="20" style="align-content: center; text-align: center;" align="center" valign="middle"  nowrap="nowrap"  scope="col"> Ket. </th>
	<!-- -->
  </tr>
</thead>
	<?php 
	...
	foreach ($data as $m): ?>
		 ...
		 if ($num % 20==0): ?>
            ...
            <thead> 
             ...
             <tr>
              ...
              <tr>
                <th width="20" style="align-content: center; text-align: center;" align="center" valign="middle"  nowrap="nowrap"  scope="col">NO</th>
                <th width="150" style="align-content: center; text-align: center;" align="center" valign="middle"  nowrap="nowrap" scope="col">Nama dan NPM</th>
                <!-- sesi -->
                <th width="20" style="align-content: center; text-align: center;" align="center" valign="middle"  nowrap="nowrap"  scope="col"> 1 </th>
                <th width="20" style="align-content: center; text-align: center;" align="center" valign="middle"  nowrap="nowrap"  scope="col"> 2 </th>
	    ...
	    <td style=" padding-left:4px;padding-right: 4px;font-size:10pt;width:100px"  nowrap="nowrap" align="left" valign="middle">
			<?=$m['nama']?><br />
			<?=$m['mhs_nim']?>
        </td>
	    <td nowrap="nowrap"></td>
	...
	<tfoot>
        <tr height="50px">
            ...
            <td style=" padding-left: 8px;padding-right: 8px;font-size:10pt;width:100px" nowrap="nowrap" align="left" valign="middle">
            PARAF DOSEN
            </td>
            <td nowrap="nowrap"></td>
            <td nowrap="nowrap"></td>
