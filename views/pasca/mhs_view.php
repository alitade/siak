...
<div class="mahasiswa-view">
    ...
    <p>
        <?= Html::a('<i class="glyphicon glyphicon-arrow-right"></i> KHS ( Kartu Hasil Study )', ['akademik/mhs-khs', 'id' => $model->mhs_nim],['class'=>'btn btn-info']) ?>
    </p>
			...
			[
				...
				'value'=>function($data,$key){
					return Html::a('<span class="glyphicon glyphicon-eye-open"></span>',
						['/pasca/mhs-krs','id'=>$_GET['id'],'kode'=>$key],['title' =>'Detail']
					);
				}
			]
