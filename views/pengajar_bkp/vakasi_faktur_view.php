...
<div class="panel panel-default">
	...
	<div class="panel-footer">
    	<span class="panel-title"><b><?=
			...
			.' '.(Funct::acc('/pengajar/vakasi-delete')?($modTrans->status==1?Html::a('<i class="fa fa-trash"></i> Hapus Faktur',['/pengajar/vakasi-delete','id'=>$modTrans->kode_transaksi],['class'=>'btn btn-success']):""):"")
			; 
		?></b></span>
    </div>
</div>