...
<div class="panel panel-primary">
    <div class="panel-heading" style="border-bottom: solid 2px #000;font-weight: bold">
        <span class="panel-title"> Perpindahan Peserta Perkuliahan
    ...
    <div class="panel-body">
        ...
        <div class="box box-primary ">
            <div class="box-header"><span style="font-weight: bold;font-size: 14px;"> <u>Jadwal Pilihan Perpindahan</u></span> </div>
            <div class="box-body">
