...
if(@$searchModel->krsHeadApp!=''){
    $ketCari.=' <span class="label label-info" style="font-size: 14px;;"><i style="color:#000">APPROVE : '.($searchModel->krsHeadApp?'Y':'N').'</i></span>&nbsp;'; $nCari+=1;
}
    ...
    echo GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'attribute'=>'kr.kode',
                'value'=>function($model){
                    return ($model->dft->keterangan?:"SMA / Sederajat ");
                },
                'width'=>'20%',
            ],
            #*/
            ...
            [
                ...
                'value'=> function($model){
                   #return $model->krs;
                    ...
                    return Html::a($link,['/krs/ds-jdwl','id'=>$model->mhs_nim],['target'=>'_blank']);
            ...
            [
                ...
                'value'=> function($model){
                    ...
                    if($model->krs_head){
                        $link=Html::a($i,['/krs/ds-mhs','id'=>$model->krs_head],['target'=>'_blank']);
