...
<div class="panel panel-primary">
    <div class="panel-heading" style="border-bottom: solid 2px #000;font-weight: bold">
        <span class="panel-title"> Perpindahan Peserta Perwalian
                    ...
                    <?php foreach($modelPilih as $d): ?>
                        <tr>
                            ...
                            <th>
                                ...
                                <?= Html::a('<i class="fa fa-arrow-left"></i> Pindahkan',['split-perwalian-manual','id'=>$model->jdwl_id,'split'=>$d->jdwl_id],['class'=>'btn btn-success btn-sm'])
                                ?>
                            </th>
                        </tr>
                    <?php endforeach; ?>
