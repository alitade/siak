...
<br /><br />
	...
	echo GridView::widget([
        ...
        'toolbar'=> [
            ['content'=>''
                //Html::a('<i class="glyphicon glyphicon-plus"></i> Tambah', ['esbed/jdw-create'],['class'=>'btn btn-success']).''.
                //Html::a('<i class="glyphicon glyphicon-download-alt"></i> Export', ['esbed/report-jadwal-kuliah'],['class'=>'btn btn-info'])
            ],
            '{toggleData}',
			'{export}',
        ],
        'columns' => [
			...
			[
				...
				'value'=>function($model){
					...
					Yii::$app->urlManager->createUrl(
						['esbed/jdw-detail','id' => $model->jdwl_id]),['title' => Yii::t('yii', 'Detail'),]
					);
				},
			...
			[
				...
				'format'=>'raw',
				'value'=>function($model){
					return "<center>".(\app\models\Funct::StatNilDos($model->jdwl_id)>0 ?'1':'0')."</center>";
				},
			],
        ],
        'responsive'=>true,
