 ...
 * @var app\models\KrsHeadSearch $searchModel
 */

$this->title = 'Krs Heads';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="krs-head-index">
    ...
    <p>
        <?php /* echo Html::a('Create Krs Head', ['create'], ['class' => 'btn btn-success'])*/  ?>
    </p>
    ...
    <?php Pjax::begin(); echo GridView::widget([
        ...
        'columns' => [
            ...
            'kr_kode',
            'app',
//            ['attribute'=>'app_date','format'=>['datetime',(isset(Yii::$app->modules['datecontrol']['displaySettings']['datetime'])) ? Yii::$app->modules['datecontrol']['displaySettings']['datetime'] : 'd-m-Y H:i:s A']], 
//            'cuid', 
...
//            'Rstat', 
            ...
            [
                ...
                'update' => function ($url, $model) {
                                    return Html::a('<span class="glyphicon glyphicon-pencil"></span>', Yii::$app->urlManager->createUrl(['krs-head/view','id' => $model->id,'edit'=>'t']), [
