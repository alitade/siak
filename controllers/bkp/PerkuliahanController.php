...
class PerkuliahanController extends Controller{
    ...
    public function actionDetailSesiKuliah($id){
        return Perkuliahan::P_uMdosen($id);
    }
    ...
    public function actionBerjalanV($id){return Perkuliahan::dPersensiBerjalan($id);}
    ...
    public function actionCetakPesertaV2($id,$jenis=1){
			...
			$pdf = new Pdf([
				...
				'methods' => [
					...
					//'SetFooter' => [$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'].'||'.date('r').' - Page {PAGENO}'],
					'SetFooter' => [$id.' ||'.date('r').' - Page {PAGENO}'],
					//'SetWatermakText' =>"asd",
					//'ShowWatermarkText'=>true,
				]
			]);
