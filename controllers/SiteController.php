...
class SiteController extends Controller
{
    ...
    public function actionTv(){
        ...
        --,'' Matakuliah
        ,cast( concat(Matakuliah,' (',STUFF((SELECT distinct ','+ jdwl_kls FROM t_absen_dosen WHERE isnull(RStat,0)=0 and Gkode_=t.Gkode_ FOR XML PATH ('')),1,1,''),')') as varchar(max))Matakuliah
        ,jam
        ,dosen
        ,Kehadiran
        ,ruangan
