...
class MatkulKrController extends Controller{
    ...
    public function actionCreate(){
        ...
        return $this->render('create', ['model' => $model, 'subAkses'=>$subAkses]);
    }
    ...
    public function actionMhsDelete(){
        $a = Yii::$app->request->post();
        $update=Mahasiswa::updateAll(['ds_wali'=>null,'uuid'=>Yii::$app->user->identity->id,'utgl'=>new  Expression("getdate()")],['mhs_nim'=>$a['selection']]);
        Yii::$app->getSession()->setFlash('success',"$update Mahasiswa Berhasil Dikeluarkan dari daftar Kurikulum Matakuliah");
    ...
    public function actionMhsCreate($id){
        ...
        if(isset($_POST[u])){
            if(isset($_POST['selection'])){
                $update = Mahasiswa::updateAll(['mk_kr'=>$model->id,'uuid'=>Yii::$app->user->identity->id,'utgl'=>new  Expression("getdate()")],[
                    'mhs_nim'=>$_POST['selection']
                ]);
                Yii::$app->getSession()->setFlash('success',"Perubahan Kurikulum Untuk $update Mahasiswa Berhasil");
                return $this->redirect(Yii::$app->request->referrer ? :['mhs-create','id'=>$model->id]);
