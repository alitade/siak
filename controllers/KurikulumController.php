...
class KurikulumController extends Controller{
    ...
    public function actionView($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
        	return $this->redirect(['/kurikulum/kr_view', 'id' => $model->kr_kode]);
        } 
		return $this->render('/kurikulum/view', ['model' => $model]);
    }
    ...
    public function actionCreate()
    {
        $model = new Kurikulum;
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['/kurikulum/view', 'id' => $model->kr_kode]);
        }
